...
β = UncertainValue(1.0,0.5) # a constructor for this custom type
...
γ = [UncertainValue(1.0,0.5), 
	 UncertainValue(-1.0,0.5)] 
...
"""    
    ...
    error propagation.
"""
Base.:*(F::AbstractMatrix,x::Estimate) = Estimate(F*x.v,F*x.C*transpose(F))
